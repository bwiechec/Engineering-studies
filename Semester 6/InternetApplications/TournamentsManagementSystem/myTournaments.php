	...
	<div class="container" style="margin-top: 70px;">
        ...
        <?php if(isset($_SESSION['komunikat'])){
         ...
         <?php
            ...
            $sql = "SELECT * FROM `user_tournament` as ut inner join `tournament` as t on t.id_tournament = ut.id_tournament WHERE id_user like '$_SESSION[id]'";
...
TEXT;   
                   ...
                   echo <<<TEXT
                   <tr>
                   <td><center><a href = "scoreTournament.php?id=$i[id_tournament]">$i[name]</a></center></td>
